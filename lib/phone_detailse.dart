...
class Phonedetailse extends StatelessWidget {
  const Phonedetailse({Key? key}) : super(key: key);
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(image: DecorationImage(image: AssetImage('images/phone6.jpg'),fit: BoxFit.cover)),
              ),
            ),
            Container(
              height: 80,
