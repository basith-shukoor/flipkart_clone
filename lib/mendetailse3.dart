...
class Mendetailse3 extends StatelessWidget {
  const Mendetailse3({Key? key}) : super(key: key);
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text("Size:"),
                            Text("S,L,M,XL",style: TextStyle(fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text("Model:"),
                            Text("US POLO",style: TextStyle(fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ),
                    ),
